...
export const volumesData: Volume[] = [
  {
    ...
    theme: "Chain",
    coverImage: "/images/theme/Chain.png",
    date: "May 2026",
    description: "Breaking limits and linking mechanics. Volume 4 challenged developers to build around constraint limits (caps) and connection links (chains) in puzzles, cryptography, or physical tethers.",
    accentColor: "#6366f1",
    bgColor: "bg-[#eef2ff]",
  ...
  },
  {
    ...
    theme: "Cap",
    coverImage: "/images/theme/Cap.png",
    date: "June 2026",
