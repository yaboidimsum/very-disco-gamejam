          ...
          {volumesData.map((vol) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                <div className="flex items-center justify-between text-zinc-400 font-sans text-[10px] tracking-wider mb-2">
                  <span>Theme:</span>
                ...
                <Link
                  href={`/volumes/${vol.id}`}
                  className="inline-flex w-full items-center justify-center rounded-xl py-3 border border-zinc-200 dark:border-zinc-800 font-sans text-[10px] tracking-widest font-bold bg-zinc-50 hover:bg-zinc-100 text-black transition-all dark:bg-zinc-900/50 dark:hover:bg-zinc-900 dark:text-white group-hover:border-zinc-400 dark:group-hover:border-zinc-700"
                >
                  Enter Volume
                </Link>
              </div>
